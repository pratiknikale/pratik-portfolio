                                        ...
                                        <div className="px-6 flex flex-col justify-center py-10">
                                            ...
                                            <div className="Project_actionButtons flex flex-wrap">
                                                <Link href={`/projects/${project.name}`}>
                                                    <button className="bg-[#F16C20] border-solid border-2 border-[#F16C20] hover:bg-[#EDEDED] hover:text-[#F16C20] w-[100px] h-[27px] rounded-[10px] mr-[11px] mt-[8px]">Read More</button>
                                                </Link>
                                                <Link href={`${project.githubLink}`} target="blank">
                                                    <button className="bg-[#F16C20] border-solid border-2 border-[#F16C20] hover:bg-[#EDEDED] hover:text-[#F16C20] w-[100px] h-[27px] rounded-[10px] mr-[11px] mt-[8px]">GitHub</button>
                                                </Link>
                                                <Link href={`${project.liveLink}`} target="blank">
                                                    <button className="bg-[#F16C20] border-solid border-2 border-[#F16C20] hover:bg-[#EDEDED] hover:text-[#F16C20] w-[100px] h-[27px] rounded-[10px] mr-[11px] mt-[8px]">Live</button>
                                                </Link>
                                            </div>
                                        </div>
